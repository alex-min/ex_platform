defmodule ExPlatformWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ExPlatformWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/ex_platform_web/templates",
        namespace: ExPlatformWeb
  ...
  defp view_helpers do
    quote do
      ...
      import ExPlatformWeb.ErrorHelpers
      import ExPlatformWeb.Gettext
      alias ExPlatformWeb.Router.Helpers, as: Routes
    end
  end
