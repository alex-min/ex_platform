defmodule ExPlatformWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_ex_platform_web_user_remember_me"
  ...
  defp maybe_write_remember_me_cookie(conn, token, %{"remember_me" => "true"}),
    do: put_remember_me_cookie(conn, token)

  defp maybe_write_remember_me_cookie(conn, _token, _params), do: conn

  @spec put_remember_me_cookie(Plug.Conn.t(), String.t()) :: Plug.Conn.t()
  defp put_remember_me_cookie(conn, token) do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      ExPlatformWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
